...
export function Profile(){
    return(
        <div>
            ...
            <p className="text-muted-foreground mb-6">Assim é como os outros verão seu perfil.</p>
            ...
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h3 className='text-sm text-muted-foreground'>joãotranquilino@gmail.com</h3>
                </div>
            </div>
