...
export function Adresses(){
    return(
        <div>
            ...
            <p className="text-muted-foreground mb-6">Estes são seus endereços cadastrados.</p>
            ...
            <form className="space-y-6">
                ...
                <Card>
                  ...
                  <CardFooter>
                    <Button variant={'link'} className="p-0 mr-8 text-blue-700">Atualizar endereço</Button>
                    <Button variant={'link'} className="p-0 text-destructive">Excluir endereço</Button>
                  </CardFooter>
                </Card>
                ...
                <div className="">
                    ...
                    <p className="text-muted-foreground mb-6">Cadastre um novo endereço para gerenciar onde serão suas entregas.</p>
                </div>
                ...
                <Button type="button" variant={'destructive'} className='ml-8'>Excluir perfil</Button>
            </form>
        </div>
    )
}