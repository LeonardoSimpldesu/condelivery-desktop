...
export function Appearance(){
    return(
        <div>
            ...
            <p className="text-muted-foreground mb-6">Costumize o visual do seu aplicativo. Troque entre tema escuro e claro.</p>
            ...
            <form className="space-y-6">
                ...
                <div className="space-y-2">
                    <div className="">
                        ...
                        <p className="text-sm text-gray-400">Selecione o tema para a sua aplicação.</p>
                    </div>
