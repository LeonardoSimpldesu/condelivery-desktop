        ...
        <div className="flex h-screen">
            ...
            <div className="flex flex-col py-20 items-center justify-between w-1/4">
                <div className="text-center flex-1 px-24">
                    ...
                    <h2 className="font-semibold text-xl">Digite seu e-mail para redefinir sua senha</h2>
                </div>
                ...
                <div className="flex flex-col flex-1 w-full px-12">
                        ...
                        <p className="text-center text-sm">Insere o endereço de e-mail que você usou para se registrar no Condelivery. Você receberá um e-mail para definir uma nova senha.</p>
