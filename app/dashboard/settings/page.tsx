    ...
    <Tabs defaultValue="profile" className="flex flex-col md:flex-row gap-8">
      <div className="lg:w-1/5">
        <TabsList
          ...
          className="flex-col w-full space-y-1 bg-white h-fit"
        >
          <TabsTrigger
            value="profile"
            className="w-full justify-start text-foreground hover:bg-slate-50 data-[state=active]:shadow-none data-[state=active]:bg-slate-100"
          >
