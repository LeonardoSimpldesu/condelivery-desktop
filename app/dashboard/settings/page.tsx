...
export default function SettingsPage() {
    ...
    return (
        <Tabs defaultValue="profile" className="flex md:flex-row gap-8">
            <div className="w-1/5 ">
                <TabsList aria-orientation="vertical" data-orientation="vertical" className='flex-col w-full space-y-1 bg-white '>
